...
fn format_distributions(version: &PackageVersion) -> ColoredString {
...
pub fn format_package_version_details(
    ...
    if details >= 5 || include_artifacts {
        display.push(format_distributions(version));
    };
...
pub fn format_package_versions(
    package: &Package,
    details: u8
) -> String {
